<template>
  <div class="app-content">
    <div class="scroll single-box">
      ...
      <img :src="image | getImgUrl" alt="" class="zhihu-info-img">
...
export default {
  async asyncData({ route, store }) {
    ...
    const res = await axios.get(`https://api.isoyu.com/index.php/api/Zhihu/news?id=${route.params.id}`);
    const comment = await axios.get(`https://api.isoyu.com/index.php/api/Zhihu/new_comment?id=${route.params.id}`);
    ...
    return {
      ...
      comment: comment.data.data.comments,
    };
  },
  components: {
    commentItem,
